...
package com.maxyspark.something.application.demomodel
...
import com.maxyspark.something.generated.demomodel._


class Router @Inject()(controller: Controller, appAction: AppAction, model: Model)(override implicit val executionContext: ExecutionContext) extends com.maxyspark.something.generated.demomodel.Router(controller, appAction, model) {
